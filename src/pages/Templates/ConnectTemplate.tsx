...
export default function ConnectTemplate({
  ...
  return (
    <main className="prose prose-rose mx-auto w-full max-w-[1200px] px-4 py-20 lg:px-0">
      <h1>Política de Privacidade de Dados</h1>

      <div className="flex w-full flex-col items-start gap-8">
        {/* <img src={CustomerLogoDark} alt="" width={400} height={300} /> */}
      ...
      <section id="legislacao-e-regulamentacao-aplicavel-3">
        ...
        <article>
          <p>
            ...
            códigos aplicáveis onde a <strong>{name}</strong> opera.
          </p>
          ...
          <p>
            ...
            Dados da <strong>{name}</strong> são alinhados a Padrões amplamente
            praticados como ISO/IEC 27001:2022, ISO/IEC 27701:2019 e Lei Geral
            de Proteção de Dados Pessoais (LGPD – Lei n° 13.709, de 14 de agosto
            de 2018).
          </p>
          <p>
            ...
            que se encontra a sede da <strong>{name}</strong>.
          </p>
        </article>
      </section>
      ...
      <section id="diretrizes">
        ...
        <article id="diretrizes-direitos-do-usuario">
          ...
          <p>
            Os serviços do <strong>{name}</strong> se comprometem a cumprir as
            normas previstas na LGPD, em respeito aos seguintes princípios:
          </p>
        ...
        <article id="diretrizes-dever-de-nao-fornecer-dados-de-terceiros">
          ...
          <p>
            ...
            de resguardar e de proteger os direitos de terceiros, o usuário do
            sistema deverá fornecer somente seus dados pessoais, e não os de
            terceiros.
          </p>
        </article>
        ...
        <article id="diretrizes-dados-pessoais-e-sensiveis">
          ...
          <div id="diretrizes-dados-pessoais-e-sensiveis-tipos-de-dados-coletados">
            ...
            <br />
            <p>
              A utilização de determinadas funcionalidades do sistema dependerá
              de cadastro, sendo que, nestes casos, os seguintes dados do
            ...
            <ul>
              ...
              <li>Número de CPF</li>
              <li>Localização em tempo real e em segundo plano</li>
            </ul>

            <strong>Permissões de Localização</strong>
            <p>
              O aplicativo {name} utiliza permissões de localização
              especificamente para o serviço de central de comando, com os
              seguintes objetivos:
            </p>
            <ul>
              <li>
            ...
            <p>
              <strong>Importante:</strong> O acesso à localização é:
            </p>
            <ul>
              <li>
                Exclusivo para a central de comando da empresa de ambulâncias
              </li>
              <li>Restrito ao período de serviço ativo do profissional</li>
              <li>Protegido contra compartilhamento não autorizado</li>
            </ul>
        ...
        <article id="diretrizes-seguranca-no-tratamento-dos-dados-pessoais">
          ...
          <p>
            No entanto, o <strong>{name}</strong> se exime de responsabilidade
            por culpa exclusiva de terceiros, como em caso de ataque de hackers
          ...
          <p>
            Por fim, o <strong>{name}</strong> se compromete a tratar os dados
            pessoais do usuário com confidencialidade, dentro dos limites
            legais.
          </p>
        </article>
